...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Test Failed. Expected Bob, got Sue. 
    // Person was being added to front of line instead of back.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Test Failed. Expected Bob, got Sue.
    // No condition for what to do with zero or negative turns.
    ...
    // Defect(s) Found: Test Failed. Expected Tim, got Sue.
    // No condition for what to do with zero or negative turns.
